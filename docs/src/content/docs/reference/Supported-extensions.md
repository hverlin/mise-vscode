...
| [bazel](https://marketplace.visualstudio.com/items?itemName=BazelBuild.vscode-bazel)                         | `bazel.executable`, `bazel.buildifierExecutable`                                                               | Does not work with shims, uses `./` instead of `${workspaceFolder}/` to avoid detection issue                                                                 |
